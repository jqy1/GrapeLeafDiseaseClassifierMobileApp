...
fun PersonalinfoScreen(
    ...
    Scaffold(
        topBar = {
            TopBar(title = stringResource(id = R.string.personal_info_edit), onClick = {
        ...
        PersonalinfoScreenBody(navController = navController)

    }
}

@Composable
fun PersonalinfoScreenBody(modifier: Modifier = Modifier,navController: NavHostController) {
