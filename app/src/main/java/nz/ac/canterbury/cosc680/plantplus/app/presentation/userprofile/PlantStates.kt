...
fun PlantstateScreen(
    ...
    Scaffold(
        topBar = {
            TopBar(title = stringResource(id = R.string.plant_states), onClick = {
        ...
        PlantstateScreenBody(navController = navController)

    }
}

@Composable
fun PlantstateScreenBody(modifier: Modifier = Modifier,navController: NavHostController) {
