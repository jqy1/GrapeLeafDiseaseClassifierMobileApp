...
fun ScanHistoryScreen(
    ...
    Scaffold(
        topBar = {
            TopBar(title = stringResource(id = R.string.scan_history), onClick = {
        ...
        ScanHistoryScreenBody(navController = navController)

    }
}

@Composable
fun ScanHistoryScreenBody(modifier: Modifier = Modifier,navController: NavHostController) {
